...
public class KoboldsItems {
	...
	public static final RegistryObject<Item> KOBOLD_POTION_HEALTH = REGISTRY.register("kobold_potion_health", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_FIRE = REGISTRY.register("kobold_potion_fire", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_STEALTH = REGISTRY.register("kobold_potion_stealth", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_COMBAT = REGISTRY.register("kobold_potion_combat", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_WATER = REGISTRY.register("kobold_potion_water", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_LEAPING = REGISTRY.register("kobold_potion_leaping", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_LEVITATION = REGISTRY.register("kobold_potion_levitation", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_POTION_MINING = REGISTRY.register("kobold_potion_mining", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE)));
	public static final RegistryObject<Item> KOBOLD_SKULL = block(KoboldsBlocks.KOBOLD_SKULL);
	public static final RegistryObject<Item> KOBOLD_INFINITY_POTION = REGISTRY.register("kobold_infinity_potion", () -> new KoboldPotionItem((new Item.Properties()).stacksTo(1).rarity(Rarity.EPIC)));
